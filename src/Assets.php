...
class Assets {
	...
	public static function enqueue_style() {
		...
		wp_enqueue_script( 'alpine', 'https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.min.js', [], '2' );
		wp_enqueue_script( 'alpine_init', CRM_URL . 'assets/js/init-alpine.js', [ 'alpine' ], filemtime( CRM_DIR . 'assets/js/init-alpine.js' ) );
		wp_enqueue_script( 'focus_trap_script', CRM_URL . 'assets/js/focus-trap.js', [], filemtime( CRM_DIR . 'assets/js/focus-trap.js' ) );
