						...
						<tr class="text-gray-700 dark:text-gray-400" data-product="<?= esc_attr( $product->id ) ?>">
							...
							<td class="px-4 py-3">
								<div class="flex items-center space-x-4 text-sm">
									...
									<button data-product="<?= esc_attr( $product->id ) ?>" @click="openModal" class="button-remove flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Delete">
										<svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
					...
					>
						...
						>
							...
							>
								...
								@click="closeModal"
								class="confirm-remove w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
								>
								Xác nhận
								</button>
							</footer>
