						...
						<tr class="text-gray-700 dark:text-gray-400" data-kho="<?= esc_attr( $warehouse->id );?>" >
							...
							<td class="action px-4 py-3">
								<div class="flex items-center space-x-4 text-sm">
									...
									<a data-kho="<?= esc_attr( $warehouse->id ) ?>" href="<?= admin_url( 'edit.php?page=kho' ) . '&id=' . $id_kho;?>" class="button-view flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="View">
